...
import { formatMoneyFromIdr, getYouTubeEmbedUrl, resolveUserLocaleCurrency } from "@/src/utils/utils";
...
export default function CartDrawer({ open, onClose }: CartDrawerProps) {
  ...
  const { locale, currency } = resolveUserLocaleCurrency();
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-white/40 text-xs mt-0.5">
                          {formatMoneyFromIdr(item.price, { locale, currency })}
                        </p>
                        {/* Quantity controls */}
              ...
              <div className="p-6 border-t border-white/5 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-syne font-bold text-lg text-neon-blue">
                    {formatMoneyFromIdr(cartTotal, { locale, currency })}
                  </span>
                </div>
