            ...
            <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                <div className="px-4 py-6 sm:px-0">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <section className="bg-white overflow-hidden shadow rounded-lg hover:bg-gray-200 transition-colors cursor-pointer">
                            <Link href={"/dashboard/orders"} className="block">
                                <div className="p-5">
                                    <div className="flex items-center">
                                        <div className="flex-shrink-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-purple-600" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7h18" /><path d="M6 11h12" /><path d="M9 15h6" /><path d="M3 4h18v16H3z" /></svg>
                                        </div>
                                        <div className="ml-5 w-0 flex-1">
                                            <dl>
                                                <dt className="text-sm font-medium text-gray-500 truncate">Manage Orders</dt>
                                                <dd className="text-sm text-gray-600">
                                                    Update labels, send emails, delete, and filter settlement orders
                                                </dd>
                                            </dl>
                                        </div>
                                    </div>
                        ...
                        {user?.role === 'admin' && (
                            <section className="bg-white overflow-hidden shadow rounded-lg hover:bg-gray-200 transition-colors cursor-pointer">
                                <Link href={"/dashboard/payment-fee"} className="block">
                                    <div className="p-5">
                                        <div className="flex items-center">
                                            <div className="flex-shrink-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-purple-600" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 1v22" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>
                                            </div>
                                            <div className="ml-5 w-0 flex-1">
                                                <dl>
                                                    <dt className="text-sm font-medium text-gray-500 truncate">Payment Fee Settings</dt>
                                                    <dd className="text-sm text-gray-600">
                                                        Manage transaction fee rules from dashboard
                                                    </dd>
                                                </dl>
                                            </div>
                                        </div>
