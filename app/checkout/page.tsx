...
import { useProduct } from "../store/context/ProductContext";
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-6">
                        ...
                        <div className="text-right">
                          ...
                          <p className="font-syne font-bold text-xl text-neon-blue">
                            {((item.price * item.quantity) / 1_000_000).toFixed(1)} ETH
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              >
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="text-white/70">{(cartTotal / 1_000_000).toFixed(1)} ETH</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-white/40">Network Fee</span>
                    <span className="text-white/70">0.02 ETH</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-syne font-bold text-neon-blue">
                      {(cartTotal / 1_000_000 + 0.02).toFixed(2)} ETH
                    </span>
                  </div>
                </div>
